...
// source: relayer/chains/fabric/msgid/msgid.proto
...
func (*MsgID) Descriptor() ([]byte, []int) {
	return fileDescriptor_e68faf7ea95b75e0, []int{0}
}
...
func init() {
	proto.RegisterType((*MsgID)(nil), "relayer.chains.fabric.msgid.MsgID")
}

func init() {
	proto.RegisterFile("relayer/chains/fabric/msgid/msgid.proto", fileDescriptor_e68faf7ea95b75e0)
}

var fileDescriptor_e68faf7ea95b75e0 = []byte{
	// 190 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x52, 0x2f, 0x4a, 0xcd, 0x49,
	0xac, 0x4c, 0x2d, 0xd2, 0x4f, 0xce, 0x48, 0xcc, 0xcc, 0x2b, 0xd6, 0x4f, 0x4b, 0x4c, 0x2a, 0xca,
	0x4c, 0xd6, 0xcf, 0x2d, 0x4e, 0xcf, 0x4c, 0x81, 0x90, 0x7a, 0x05, 0x45, 0xf9, 0x25, 0xf9, 0x42,
	0xd2, 0x50, 0x85, 0x7a, 0x10, 0x85, 0x7a, 0x10, 0x85, 0x7a, 0x60, 0x25, 0x52, 0x22, 0xe9, 0xf9,
	0xe9, 0xf9, 0x60, 0x75, 0xfa, 0x20, 0x16, 0x44, 0x8b, 0x92, 0x0c, 0x17, 0xab, 0x6f, 0x71, 0xba,
	0xa7, 0x8b, 0x90, 0x30, 0x17, 0x6b, 0x49, 0x45, 0x7c, 0x66, 0x8a, 0x04, 0xa3, 0x02, 0xa3, 0x06,
	0x67, 0x10, 0x4b, 0x49, 0x85, 0x67, 0x8a, 0x53, 0xf0, 0x89, 0x87, 0x72, 0x0c, 0x27, 0x1e, 0xc9,
	...
	0x9c, 0x9f, 0xab, 0x5f, 0x94, 0x99, 0x98, 0x57, 0x96, 0x98, 0x93, 0x9c, 0x98, 0x97, 0x98, 0x99,
	0xa8, 0x9f, 0x99, 0xac, 0x5b, 0x59, 0x9a, 0xa9, 0x8b, 0xd5, 0xdd, 0x49, 0x6c, 0x60, 0x9b, 0x8d,
	0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x90, 0x21, 0xda, 0x4a, 0xd7, 0x00, 0x00, 0x00,
}
...
func (m *MsgID) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TxId) > 0 {
		i -= len(m.TxId)
		copy(dAtA[i:], m.TxId)
		i = encodeVarintMsgid(dAtA, i, uint64(len(m.TxId)))
		i--
		dAtA[i] = 0xa
	}
